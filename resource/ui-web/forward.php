...
<button type="button" class="btn btn-outline-secondary btn-sm mt-1" style="border-Radius: 0px;" onclick="RproxySswitch()">展开</button>
          ...
          <div id="RproxySbody" class="card-body" style="display:<?php if (empty($RproxySconf) === false) echo 'block'; else echo 'none';?>">
            ...
            <div class="card mb-3 mt-2">
              <div class="card-header">
                代理型
<span id="RproxyS0Button" class="float-right mt-n1 mb-n2" style="display:<?php if (strpos(json_encode($RproxySconf), "connectIn") !== false) echo 'block'; else echo 'none';?>">
<button id="buttonRproxyS0Stop" type="button" class="btn btn-outline-secondary btn-sm mt-1" style="border-Radius: 0px;">关闭</button>
</span>
<span id="RproxyS0Switch" class="float-right mt-n1 mb-n2" style="display:<?php if (strpos(json_encode($RproxySconf), 'connectIn') !== false) echo 'none'; else echo 'block';?>">
<button type="button" class="btn btn-outline-secondary btn-sm mt-1" style="border-Radius: 0px;" onclick="RproxyS0Switch()">展开</button>
</span>
              </div>
              <div id="RproxyS0Body" class="card-body" style="display:<?php if (strpos(json_encode($RproxySconf), 'connectIn') !== false) echo 'block'; else echo 'none';?>">
                <div class="form-row">
                  <div class="col-md-3 mt-auto">
                  <div class="input-group my-2">
                    <div class="input-group-prepend">
                    ...
                    <span class="input-group-text form-control"><?php echo $de_GWDconf->FORWARD->domain ?>:<?php echo $de_GWDconf->FORWARD->Rproxy->server->in->port ?></span>
                  </div>
                  </div>
                  ...
                  <div class="input-group my-2">
                    ...
                    <input id="RproxySinPort" type="text" class="form-control" value="<?php echo $de_GWDconf->FORWARD->Rproxy->server->in->port ?>">
                  </div>
                  </div>
...
RproxySinPort=$('#RproxySinPort').val()
...
$.get('./act/RproxySsave.php', {RproxySinPort:RproxySinPort, RproxySinUUID:RproxySinUUID, RproxyStunnelPort:RproxyStunnelPort, RproxyStunnelUUID:RproxyStunnelUUID, RproxySinStatus:RproxySinStatus, RproxySmappingStatus:RproxySmappingStatus, RproxyS1List:RproxyS1List}, function(result){
