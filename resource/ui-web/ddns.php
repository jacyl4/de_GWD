...
$.get('./act/onDDNS3322.php', {f3322domain:f3322domain, f3322usr:f3322usr, f3322pwd:f3322pwd}, function(result){window.location.reload()})
alert("应用DDNS。。。")
})

$('#buttonddns3322off').click(function(){
$.get('./act/offDDNS3322.php', function(result){window.location.reload()})
})
...
cfemail=$('#CFemail').val()
$.get('./act/onDDNScf.php', {CFdomain:cfdomain, CFzoneid:cfzoneid, CFapikey:cfapikey, CFemail:cfemail}, function(result){window.location.reload()})
alert("应用DDNS。。。")
})

$('#buttonddnsCFoff').click(function(){
$.get('./act/offDDNScf.php', function(result){window.location.reload()})
})
