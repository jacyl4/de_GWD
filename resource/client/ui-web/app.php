...
<button id="installNetdata" type="button" class="btn <?php if ($checkNetdata === true) echo 'btn-success'; else echo 'btn-outline-secondary';?> btn-sm ml-4 mb-3 mr-auto" style="border-Radius: 0px;">Netdata</button>
...
<button id="buttonDockerInstall" type="button" class="btn <?php if ($checkDocker === true) echo 'btn-outline-success'; else echo 'btn-outline-secondary'; ?> btn-sm mt-1" style="border-Radius: 0px;">install</button>
    ...
    <div class="form-row">
      ...
      <div class="col-md-6 input-group my-2">
        ...
        <div class="input-group-append">
          <button id="buttonJellyfinRestore" type="button" class="btn btn-outline-secondary">
