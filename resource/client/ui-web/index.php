...
<?php $smartdnsConf = file_get_contents('/opt/de_GWD/smartdns/smartdns.conf'); preg_match_all('/(?<=\bhttps:\/\/)\S+/is', $smartdnsConf, $DOHstr);?>
          <div class="card-body">
            <div class="form-row">
              <div class="col-md-5">
...
if(($index = array_search('127.0.0.1:5335',$dnsClist[0]))){
  unset($dnsClist[0][$index]);
  }
