    ...
    <div id="content-wrapper" class="mx-auto" style="max-width: 1600px;">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">DDNS & Wireguard</li>
        </ol>
    ...
    <div class="modal-content">
      ...
      <div class="col-md-5 input-group mx-auto mb-3">
        ...
        <div class="input-group-append">
          <button id="buttonShowIP" type="button" class="btn btn-secondary btn-sm">
            <span id="buttonShowIPLoading"></span>
            查询
          </button>
        </div>
      </div>
...
$("#buttonShowIPLoading").attr("class", "spinner-border spinner-border-sm")
$.get('./act/checkDDNSip.php', function(data){
  $('#wanIP').attr("value",data)
  $("#buttonShowIPLoading").removeClass()
})
})
...
$.get('./act/offDDNS3322.php', function(result){
  ...
  $('#ddns3322switch').css('display', 'block'); 
  $('#ddns3322button').css('display', 'none'); 
  $('#ddns3322body').css('display', 'none'); 
})
})
...
$.get('./act/offDDNScf.php', function(result){
  ...
  $('#ddnsCFswitch').css('display', 'block'); 
  $('#ddnsCFbutton').css('display', 'none'); 
  $('#ddnsCFbody').css('display', 'none'); 
})
})
