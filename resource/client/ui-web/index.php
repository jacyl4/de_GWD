  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-body">
        ...
        <textarea id="adBlistURL" class="form-control" style="border-Radius: 0px;" rows="8" placeholder="广告域名"><?php print(implode("\n", $de_GWDconf->dns->adBlistURL)) ?></textarea>
        ...
        <textarea id="adWlistURL" class="form-control" style="border-Radius: 0px;" rows="8" placeholder="非广告域名"><?php print(implode("\n", $de_GWDconf->dns->adWlistURL)) ?></textarea>
      </div>
      <div class="modal-footer">
