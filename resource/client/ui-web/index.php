      ...
      <div class="modal-body">
              <div class="card">
                <div class="card-header">
                  ...
                  <textarea id="listB" class="form-control" aria-label="listB" rows="12" placeholder="一行一个域名" style="border-Radius: 0px;"><?php foreach ($de_GWDconf->dns->listB as $k => $v) {echo "$k\n";} ?></textarea>
              </div>
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <textarea id="listW" class="form-control" aria-label="listW" rows="12" placeholder="一行一个域名"><?php foreach ($de_GWDconf->dns->listW as $k => $v) {echo "$k\n";} ?></textarea>
              </div>
      </div>
      <div class="modal-footer">
...
<?php $smartdnsConf = file_get_contents('/etc/smartdns/smartdns.conf'); preg_match_all('/(?<=\bhttps:\/\/)\S+/is', $smartdnsConf, $DOHstr);?>
          <div class="card-body">
            <div class="form-row">
              <div class="col-md-5">
              <div class="input-group my-2">
                ...
                <input type="text" id="DoH1" class="form-control" placeholder="域名:端口/dq" required="required" value="<?php echo $DOHstr[0][0];?>">
                <div class="input-group-append">
              ...
              <div class="input-group my-2">
                ...
                <input type="text" id="DoH2" class="form-control" placeholder="域名:端口/dq" required="required" value="<?php echo $DOHstr[0][1];?>">
                <div class="input-group-append">
...
$.get("./act/submitADList.php", {adlistsURL:adlistsURL, regexRule:regexRule}, function(result){
