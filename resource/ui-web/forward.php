...
<button id="buttonFWD0save" type="button" class="btn <?php if ($checkFWD0 === false) echo 'btn-success'; else echo 'btn-outline-secondary';?> btn-sm mt-1" style="border-Radius: 0px;">
...
<button id="buttonFWD1save" type="button" class="btn <?php if ($checkFWD1 === true) echo 'btn-success'; else echo 'btn-outline-secondary';?> btn-sm mt-1" style="border-Radius: 0px;">
