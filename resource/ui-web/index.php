...
<div class="input-group ml-4 mt-1 mb-4">
  ...
  <div class="input-group-append">
    <button id="nodenfshow" class="btn btn-outline-secondary dropdown-toggle" type="button" data-toggle="dropdown"><?php $nodenfnum = exec('/opt/de_GWD/ui-checkNodeNF >/dev/null 2>&1 &'); echo json_decode(file_get_contents('/opt/de_GWD/0conf'))->v2node[$nodenfnum]->name; ?></button>
...
<div class="input-group ml-4 mt-1 mb-1">
  ...
  <div class="input-group-append">
    <button id="nodedtshow" class="btn btn-outline-secondary dropdown-toggle" type="button" data-toggle="dropdown"><?php $nodedtnum = exec('/opt/de_GWD/ui-checkNodeDT >/dev/null 2>&1 &'); echo json_decode(file_get_contents('/opt/de_GWD/0conf'))->v2node[$nodedtnum]->name; ?></button>
