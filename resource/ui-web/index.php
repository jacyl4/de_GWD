        ...
        <div class="card mb-3">
         ...
         <span class="float-right mt-n1 mb-n2">
              <div class="btn-group">
                ...
                <button id="buttonOnUDP" type="button" class="btn btn-<?php passthru('sudo /opt/de_GWD/ui-checkUDP');?> btn-sm mt-1" style="border-radius: 0px;">
...
<?php $nodeDT = json_decode(file_get_contents('/opt/de_GWD/0conf'))->divertLan->display; ?>
<div class="input-group">
  ...
  <div id="nodeDTip" class="input-group-prepend input-group-append" style="display:<?php if($nodeDT == block) echo 'block'; else echo 'none'; ?>">
    <input id="nodedttext" type="text" class="form-control" placeholder="内网设备IP 空格分隔" value="<?php foreach (json_decode(file_get_contents('/opt/de_GWD/0conf'))->divertLan->ip as $k => $v) {echo "$v ";} ?>">
  </div>
