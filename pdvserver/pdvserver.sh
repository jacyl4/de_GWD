...
wget http://seso.icu/pdvserver/doh-amd64/doh-server
wget http://seso.icu/pdvserver/doh-amd64/doh-server.conf
wget http://seso.icu/pdvserver/doh-amd64/doh-server.service
...
wget https://seso.icu/pdvserver/v2wt-server.json
