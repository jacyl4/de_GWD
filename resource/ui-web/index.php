      ...
      <div class="modal-footer">
        ...
        <div class="card mb-3">
         ...
         <span class="float-right mt-n1 mb-n2">
                <button id="buttonNodeDTshow" type="button" class="btn btn-outline-secondary btn-sm mt-1" style="border-radius: 0px;">
                  <span id="buttonNodeDTshowLoading"></span>
                  <span>启用内网设备分流</span>
                </button>
                <button id="buttonNodeDThide" type="button" class="btn btn-outline-secondary btn-sm mt-1" style="border-radius: 0px;">
                  <span id="buttonNodeDThideLoading"></span>
                  <span>禁用内网设备分流</span>
                </button>
          </span>
          </div>
...
<div class="input-group mr-4 mt-1 mb-4">
  <div class="input-group-prepend">
    <button id="buttonOnUDP" class="btn btn-<?php passthru('sudo /opt/de_GWD/ui-checkUDP');?>" type="button">
      <span id="buttonOnUDPloading"></span>
      <span>UDP代理</span>
    </button>
  </div>
  <div class="input-group-append">
    <button id="buttonOffUDP" class="btn btn-secondary" type="button">
...
<div class="input-group mr-4 mt-1">
  ...
  <div class="input-group-append">
    <button id="buttonSubmitDivertIP" class="btn btn-secondary" type="button">
      ...
      <span>IP写入</span>
        ...
        <div class="card mb-3">
          ...
          <span class="float-right mt-n1 mb-n2">
                ...
                <button id="buttonclearDNS" type="button" class="btn btn-outline-secondary btn-sm mt-1 ml-2" style="border-radius: 0px;">
        ...
        <div class="card mb-3">
          ...
          <span class="float-right mt-n1 mb-n2">
                ...
                <button id="buttonOffDHCP" type="button" class="btn btn-outline-secondary btn-sm mt-1 ml-2" style="border-radius: 0px;">
...
$("#buttonNodeDTshowLoading").attr("class", "spinner-border spinner-border-sm")
$.get('./act/switchNodeDT.php', {switchNodeDT:"NodeDTshow"}, function(result){
  $("#buttonNodeDTshowLoading").removeClass()
  $("#shnodedt").css("display", "block")
})
})

$('#buttonNodeDThide').click(function(){
$("#buttonNodeDThideLoading").attr("class", "spinner-border spinner-border-sm")
$.get('./act/switchNodeDT.php', {switchNodeDT:"NodeDThide"}, function(result){
  $("#buttonNodeDThideLoading").removeClass()
...
$.get('./act/onUDP.php', function(result){
  ...
  $('#buttonOnUDP').attr('class', 'btn btn-success')
})
})
...
$.get('./act/offUDP.php', function(result){
  ...
  $('#buttonOnUDP').attr('class', 'btn btn-outline-secondary')
})
})
