...
var adlistLoadDefault=$.ajax({url:"/act/adlistsDefault",async:false})
...
var adBregexLoadDefault=$.ajax({url:"/act/adBregexDefault",async:false})
$("#adBregex").val(adBregexLoadDefault.responseText)
})

$('#adWlistLoad').click(function(){
var adWlistLoadDefault=$.ajax({url:"/act/adWlistDefault",async:false})
$("#adWlist").val(adWlistLoadDefault.responseText)
})

$('#adWregexLoad').click(function(){
var adWregexLoadDefault=$.ajax({url:"/act/adWregexDefault",async:false})
