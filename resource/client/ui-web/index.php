      ...
      <div class="modal-footer">
        ...
        <div class="card mb-3">
         ...
         <span class="float-right mt-n1 mb-n2">
                ...
                <button id="buttonOnAPPLE" type="button" class="btn btn-<?php if(strpos($v2dnsConf,'domain:icloud.com') !== false) echo 'success'; else echo 'outline-secondary'; ?> btn-sm mt-1 mr-2" style="border-radius: 0px;">
