...
<span class="float-right badge text-success"><?php passthru('sudo /opt/de_GWD/ui-checkEditionFWD');?></span>
    ...
    <ul class="navbar-nav ml-auto ml-md-0">
      <li class="nav-item no-arrow mx-1" style="display:<?php if (file_exists('/usr/bin/jellyfin')) echo 'block'; else echo 'none';?>">
      ...
      <li class="nav-item no-arrow mx-1" style="display:<?php if (file_exists('/usr/libexec/netdata/netdata-updater.sh')) echo 'block'; else echo 'none';?>">
...
<div class="input-group ml-4 mt-1 my-2">
  ...
  <div class="input-group-append">
    <button id="v2nodeNAMEshow" class="btn btn-outline-secondary dropdown-toggle" type="button" data-toggle="dropdown" value="<?php echo json_decode(file_get_contents('/opt/de_GWD/0conf'))->FORWARD->FWD1->upstream ?>"><?php passthru('sudo /opt/de_GWD/ui-checkVtrui1') ?></button>
