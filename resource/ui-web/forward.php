...
<div class="form-group form-check ml-4 mt-1 my-2">
    ...
    <label class="form-check-label" for="portCheck1">阻止外部访问本机53端口</label>
              ...
              <div class="input-group my-2">
                ...
                <input type="text" id="FWD0path" class="form-control" value="<?php echo $de_GWDconf->FORWARD->FWD0->path ?>">
              </div>
              </div>
  ...
  <div class="input-group-append">
    ...
    <div id="v2nodeNAME" class="dropdown-menu">
              ...
              <div class="input-group my-2">
                ...
                <input type="text" id="FWD1path" class="form-control" value="<?php echo $de_GWDconf->FORWARD->FWD1->path ?>">
              </div>
              </div>
