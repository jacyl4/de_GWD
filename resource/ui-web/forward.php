    ...
    <div class="form-row">
      <div class="col-md-3 input-group my-2">
        <div class="input-group-prepend">
          ...
          <input type="text" id="CFdomain" class="form-control" value="<?php echo $de_GWDconf->FORWARD->domain ?>">
      </div>
      ...
      <div class="col-md-5 input-group my-2">
        <div class="input-group-prepend">
          ...
          <input type="text" id="CFapikey" class="form-control" value="<?php echo $de_GWDconf->FORWARD->APIkey ?>">
      </div>
      ...
      <div class="col-md-4 input-group my-2">
        <div class="input-group-prepend">
          ...
          <input type="text" id="CFemail" class="form-control" value="<?php echo $de_GWDconf->FORWARD->Email ?>">
      </div>
    </div>
          </div>
        </div>
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            xDNS server
<span class="float-right mt-n1 mb-n2" id="xDNSsButton" style="display:<?php if ($xDNSsConf === true) echo 'block'; else echo 'none';?>">
<div class="btn-group">
...
<span class="float-right mt-n1 mb-n2" id="xDNSsSwitch" style="display:<?php if ($xDNSsConf === true) echo 'none'; else echo 'block';?>">
<button type="button" class="btn btn-outline-secondary btn-sm mt-1" style="border-Radius: 0px;" onclick="xDNSsSwitch()">展开</button>
</span>
          </div>

          <div class="card-body" id="xDNSsBody" style="display:<?php if ($xDNSsConf === true) echo 'block'; else echo 'none';?>">
            <div class="form-row">
              ...
              <div class="input-group my-2">
                ...
                <input type="text" id="xDNSsPort" class="form-control" value="<?php echo $de_GWDconf->FORWARD->xDNSs->port ?>">
              </div>
              </div>
            </div>
        ...
        <div class="card mb-3">
          <div class="card-header">
            <i class="fas fa-reply"></i>
            默认中转线
<span class="float-right mt-n1 mb-n2" id="FWD0button" style="display:<?php if ($checkFWD0 === false) echo 'block'; else echo 'none';?>">
<div class="btn-group">
...
<span class="float-right mt-n1 mb-n2" id="FWD0switch" style="display:<?php if ($checkFWD0 === false) echo 'none'; else echo 'block';?>">
<button type="button" class="btn btn-outline-secondary btn-sm mt-1" style="border-Radius: 0px;" onclick="FWD0switch()">展开</button>
</span>
          </div>

          <div class="card-body" id="FWD0body" style="display:<?php if ($checkFWD0 === false) echo 'block'; else echo 'none';?>">
            <div class="form-row">
              <div class="col-md-3 mt-auto">

<span class="float-left mb-3">
<div class="form-group form-check ml-4 mt-1 my-2">
    <input type="checkbox" class="form-check-input" id="portCheck1" <?php echo $de_GWDconf->FORWARD->PortCheck1 ?>>
    <label class="form-check-label" for="portCheck1">阻止外部访问本机53端口</label>
              ...
              <div class="input-group my-2">
                ...
                <input type="text" id="FWD0port" class="form-control" value="<?php echo $de_GWDconf->FORWARD->FWD0->port ?>">
              </div>
              </div>
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            并行中转线
<span class="float-right mt-n1 mb-n2" id="FWD1button" style="display:<?php if ($checkFWD1 === true) echo 'block'; else echo 'none';?>">
<div class="btn-group">
...
<span class="float-right mt-n1 mb-n2" id="FWD1switch" style="display:<?php if ($checkFWD1 === true) echo 'none'; else echo 'block';?>">
<button type="button" class="btn btn-outline-secondary btn-sm mt-1" style="border-Radius: 0px;" onclick="FWD1switch()">展开</button>
</span>
          </div>

          <div class="card-body" id="FWD1body" style="display:<?php if ($checkFWD1 === true) echo 'block'; else echo 'none';?>">
            <div class="form-row">
              <div class="col-md-3 mt-auto">
  ...
  <div class="input-group-append">
    ...
    <div id="v2nodeNAME" class="dropdown-menu">
              ...
              <div class="input-group my-2">
                ...
                <input type="text" id="FWD1port" class="form-control" value="<?php echo $de_GWDconf->FORWARD->FWD1->port ?>">
              </div>
              </div>
