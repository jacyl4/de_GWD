      ...
      <div class="col-md-6 input-group ml-auto mr-auto mb-3">
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            CloudFlare DDNS
          <span class="badge badge-pill badge-success mt-auto mb-auto"><?php echo shell_exec('sudo /usr/local/bin/ui-checkDDNScf');?></span>
      ...
      <div class="col-md-6 input-group my-1">
        ...
        <div class="card mb-3">
          <div class="card-header">
            <i class="fas fa-ethernet"></i>
            WireGuard Server
          <span class="badge badge-pill badge-success mt-auto mb-auto"><?php echo shell_exec('sudo /usr/local/bin/ui-checkWG');?></span>
<span class="float-right mt-n1 mb-n2">
