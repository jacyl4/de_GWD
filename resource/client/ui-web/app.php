...
<button id="installNetdata" type="button" class="btn <?php if ($checkNetdata === true) echo 'btn-success'; else echo 'btn-outline-secondary';?> btn-sm ml-4 mb-3" style="border-Radius: 0px;">Netdata</button>
<button id="installJellyfin" type="button" class="btn <?php if ($checkJellyfin === true) echo 'btn-success'; else echo 'btn-outline-secondary';?> btn-sm ml-4 mb-3 mr-auto" style="border-Radius: 0px;">Jellyfin</button>
