...
<button id="buttonSaveNode" type="button" class="btn btn-outline-secondary btn-sm mt-1" style="border-Radius: 0px;">保存</button>
</span>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-bordered table-striped text-center">
                <thead>
                  <tr>
                    <th><button id="buttonAddLine" type="button" class="form-control btn btn-outline-secondary btn-sm my-n2" style="border-Radius: 0px;">+</button></th>
