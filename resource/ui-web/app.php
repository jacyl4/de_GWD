...
<button id="installNetdata" type="button" class="btn btn-<?php if (file_exists('/usr/libexec/netdata/netdata-updater.sh')) echo 'success'; else echo 'outline-secondary';?> btn-sm ml-4 mb-3" style="border-Radius: 0px;">install Netdata</button>
<button id="installJellyfin" type="button" class="btn btn-<?php if (file_exists('/usr/bin/jellyfin')) echo 'success'; else echo 'outline-secondary';?> btn-sm ml-4 mb-3" style="border-Radius: 0px;">install Jellyfin</button>
</div>
