    ...
    <div class="form-row">
      <div class="col-md-4 input-group my-2">
        <div class="input-group-prepend">
          ...
          <input id="f3322domain" type="text" class="form-control" value="<?php echo json_decode($de_GWDconf)->ddns->ddns3322->domain ?>">
      </div>
      ...
      <div class="col-md-4 input-group my-2">
        <div class="input-group-prepend">
          ...
          <input id="f3322usr" type="text" class="form-control" value="<?php echo json_decode($de_GWDconf)->ddns->ddns3322->user ?>">
      </div>
      ...
      <div class="col-md-4 input-group my-2">
        <div class="input-group-prepend">
          ...
          <input id="f3322pwd" type="text" class="form-control" value="<?php echo json_decode($de_GWDconf)->ddns->ddns3322->pwd ?>">
      </div>
    </div>
          </div>
        </div>
    ...
    <div class="form-row">
      <div class="col-md-6 input-group my-2">
        <div class="input-group-prepend">
          ...
          <input id="CFdomain" type="text" class="form-control" value="<?php echo json_decode($de_GWDconf)->ddns->ddnsCF->cfDomain ?>">
      </div>
      ...
      <div class="col-md-6 input-group my-2">
        <div class="input-group-prepend">
          ...
          <input id="CFzoneid" type="text" class="form-control" value="<?php echo json_decode($de_GWDconf)->ddns->ddnsCF->cfZoneID ?>">
      </div>
    </div>
    ...
    <div class="form-row">
      <div class="col-md-6 input-group my-2">
        <div class="input-group-prepend">
          ...
          <input id="CFapikey" type="text" class="form-control" value="<?php echo json_decode($de_GWDconf)->ddns->ddnsCF->cfAPIkey ?>">
      </div>
      ...
      <div class="col-md-6 input-group my-2">
        <div class="input-group-prepend">
          ...
          <input id="CFemail" type="text" class="form-control" value="<?php echo json_decode($de_GWDconf)->ddns->ddnsCF->cfEmail ?>">
      </div>
    </div>
          </div>
        </div>
    ...
    <div class="form-row">
      <div class="input-group my-2 col-md-12">
        <div class="input-group-prepend">
          ...
          <input id="FRPdomain" type="text" class="form-control" style="max-width: 280px;" value="<?php echo json_decode($de_GWDconf)->FRP->server->domain ?>">
        <div class="input-group-prepend input-group-append">
          <span class="input-group-text">Token</span>
        </div>
          <input id="FRPtoken" type="text" class="form-control" style="max-width: 150px;" value="<?php echo json_decode($de_GWDconf)->FRP->server->token ?>">
        <div class="input-group-prepend input-group-append">
          <span class="input-group-text">Bind-Port</span>
        </div>
          <input id="FRPbindPort" type="text" class="form-control" style="max-width: 125px;" value="<?php echo json_decode($de_GWDconf)->FRP->server->bindPort ?>">
        <div class="input-group-prepend">
          <button id="FRPbindProtocol" class="btn btn-outline-secondary dropdown-toggle" style="min-width: 80px;" type="button" data-toggle="dropdown"><?php echo json_decode($de_GWDconf)->FRP->server->bindProtocol ?></button>
