...
iptables -t mangle -I OUTPUT -p tcp -j V2PROXY
iptables -t mangle -I OUTPUT -p udp -j V2PROXY

iptables -t mangle -I PREROUTING -p tcp -j TPROXY --on-ip 127.0.0.1 --on-port 9896 --tproxy-mark 0x9
iptables -t mangle -I PREROUTING -p udp -j TPROXY --on-ip 127.0.0.1 --on-port 9896 --tproxy-mark 0x9

iptables -t mangle -I PREROUTING -p tcp -m mark ! --mark 0x9 -j V2PROXY
iptables -t mangle -I PREROUTING -p udp -m mark ! --mark 0x9 -j V2PROXY
