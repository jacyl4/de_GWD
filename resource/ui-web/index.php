...
<div id="ssDetail" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button id="buttonSubmitSS" type="button" class="btn btn-outline-secondary btn-sm">
          <span id="buttonSubmitSSloading"></span>
          <span>应用</span>
        </button>
      </div>
    </div>
...
$('#buttonSubmitSS').click(function(){
$("#buttonSubmitSSloading").attr("class", "spinner-border spinner-border-sm")
...
$.get('./act/changeNodeSS.php', {ssAddress:ssAddress, ssPort:ssPort, ssMethod:ssMethod, ssSecure:ssSecure}, function(result){
  $("#buttonSubmitSSloading").removeClass()
  $("#ssDetail").modal('hide')
