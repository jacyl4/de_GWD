...
<button id="buttonFWD0save" type="button" class="btn btn-<?php passthru('sudo /opt/de_GWD/ui-checkFWD0');?> btn-sm mt-1" style="border-Radius: 0px;">应用</button>
...
<button id="buttonFWD1save" type="button" class="btn btn-<?php passthru('sudo /opt/de_GWD/ui-checkFWD1');?> btn-sm mt-1" style="border-Radius: 0px;">应用</button>
