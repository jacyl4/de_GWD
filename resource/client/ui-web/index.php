...
<div id="editADlists" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-body">
        <textarea id="adlistsURL" class="form-control" rows="12" placeholder="ADlists URL">
<?php for( $i=0; $i<count($de_GWDconf->dns->adlistsURL); $i++){ echo $de_GWDconf->dns->adlistsURL[$i]; echo "\n";} ?>    
        </textarea>
      </div>
      <div class="modal-footer">
...
$.get("./act/adlistsSubmit.php", {adlistsURL:adlistsURL}, function(result){
