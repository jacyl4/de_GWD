    ...
    <button id="buttonRestore" type="button" class="btn btn-outline-secondary">
      ...
      <div class="input-group my-2 col-md-4">
        <div class="input-group-prepend">
          ...
          <input id="updateAddr" type="text" class="form-control" value="<?php echo json_decode($de_GWDconf)->update->updateAddr ?>">
        <div class="input-group-prepend input-group-append">
          <span class="input-group-text justify-content-center">端口</span>
        </div>
          <input id="updatePort" type="text" class="form-control col-md-2" value="<?php echo json_decode($de_GWDconf)->update->updatePort ?>">
      </div>
      ...
      <div class="input-group my-2 col-md-8">
        <div class="input-group-prepend">
          ...
          <input id="updateCMD" type="text" class="form-control" value="<?php echo json_decode($de_GWDconf)->update->updateCMD ?>">
